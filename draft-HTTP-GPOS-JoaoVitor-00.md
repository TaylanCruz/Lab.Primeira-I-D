...
## 1. Introduction
Esse protocolo é uma extensão ao protocolo HTTP, para permitir requisição de localização geográfica de um site. Isso será possível adicionando um campo na mensagem HTTP que será definido a partir da RFC 1712.
...
>Os atributos de GPOS: longitude, latitude, longitude; são deifinido de acordo com a RFC 1712.
...
[RFC1712]	Farrel, C., Schulze, M., Pleitner, S. and Baldoni, D., "DNS Encoding of Geographical Location", RFC 1712, November 1994.
