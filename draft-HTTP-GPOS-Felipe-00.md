...
# Title draft-HTTP-GPOS-FELIPE-FALCAO-00.txt
...
## 1. Introduction
> O serviço HTTP-GPOS é um serviço de geolocalização de endereços IP, útil para resolução de problemas que envolvem a necessidade de localizar a origem de requisições ao servidor, como por exemplo o GPS. A partir de tal ideia, pode-se implementar aplicativos de localização, jogos e de busca mais eficientes.
> O GPOS torna-se essencial na aplicação de tal façanha, visto que disponibiliza uma forma de transmitir longitude, latitude e longitude. Tal serviço utiliza-se de uma extensão do protocolo HTTP com GPOS. 
...
[RFC2616]       R. Fielding, J. Gettys, J. Mogul, H. Frystyk, L. Masinter, P. Leach, T. Berners-Lee, "Hypertext Transfer Protocol -- HTTP/1.1", RFC2616, June 1999.

[RFC2009]	T. Imielinski, J. Navas, "GPS-Based Addressing and Routing", RFC2009, November 1996.
